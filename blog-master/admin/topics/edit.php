  ...
  <div class="admin-wrapper clearfix">
    ...
    <div class="left-sidebar">
      <ul>
        ...
        <li><a href="../topics/index.php">Administrar Topics</a></li>
        <li><a href="../users/index.php">Administrar Users</a></li>
      </ul>
    </div>
    <!-- // Left Sidebar -->
    ...
    <div class="admin-content clearfix">
      <div class="button-group">
        ...
        <a href="index.php" class="btn btn-sm">Administrar Topics</a>
      </div>
      <div class="">
